...
- The closed-form IEEE 80 equations assume uniform soil, a rectangular (or L/T-shaped) grid
  and uniform current leakage. Outside those assumptions, believe the numerical solver.
- The numerical solver assumes a horizontally layered earth, power-frequency behaviour and
  perfectly bonded metal. It does **not** model soil ionisation, the frequency-dependent
  impulse response of an electrode under a lightning stroke, or the longitudinal impedance
  of very long electrodes.
